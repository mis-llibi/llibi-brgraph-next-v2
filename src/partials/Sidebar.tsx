      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink href="/dashboard" className="block">
            <img src={"/logo.svg"} alt="LLIBI LOGO" className="w-64" />
          </NavLink>
        </div>
                        ...
                        <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                          <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                            <li className="mb-1 last:mb-0">
                              <NavLink href="/client/search-client">
                    ...
                    return (
                      <React.Fragment>
                        ...
                        <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                          <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                            <li className="mb-1 last:mb-0">
                              <NavLink href="/admin/user-management">
                                <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                  User Management
                                </span>
                              </NavLink>
                            ...
                            <li className="mb-1 last:mb-0">
                              <NavLink href="/admin/client-management">
                                <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                  Client Management
                                </span>
                              </NavLink>
                            ...
                            <li className="mb-1 last:mb-0">
                              <NavLink href="/admin/admin-management">
                                <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                  Admin Management
                                </span>
                              </NavLink>
